              ...
              <div className="col-lg-6">
                <div className="text-center my-5">
                  <h1 className="display-5 fw-bolder text-white mb-2">
                    {" "}
                    Solve your toughest problems as a sports manager{" "}
                  </h1>
                  <p className="lead text-white-50 mb-4">
                    {" "}
                    Spend your time growing your organization. Not on paperwork
                    or clunky software. Let our solutions make your life easier.{" "}
                  </p>
          ...
          <div className="container px-5 my-5">
            <div className="row gx-5">
              <div className="col-lg-4 mb-5 mb-lg-0">
                ...
                <p>
                  Reward your members for inviting their friends. Create a
                  referral program with automatic tracking and rewards.{" "}
                </p>
              ...
              <div className="col-lg-4 mb-5 mb-lg-0">
                ...
                <p>
                  Create and share sports schedules for leagues and tournaments.
                  Update scores and track standings online.
                </p>
                <a className="text-decoration-none" href="#!">
                  Learn more
                  <i className="bi bi-arrow-right" />
              ...
              <div className="col-lg-4">
                ...
                <p>
                  Accept online sports registrations and payments. Gather player
                  info and offer discounts or promotions
                </p>
                <a className="text-decoration-none" href="#!">
                  Learn more
                  <i className="bi bi-arrow-right" />
