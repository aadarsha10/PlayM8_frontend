...
export default function AddPlayerRank() {
    ...
    const [topRankCheck, settopRankCheck] = useState(false);
    ...
    const playerRankingAdd = (e) => {
        ...
        rankData.append("TopRankCheck", topRankCheck)
        ...
        axios
            .post("http://localhost:5000/admin/add/playerRank", rankData)
            .then((response) => {
                console.log("response", response.data.message);

                if (response.data.message === "Added Ranking") {
